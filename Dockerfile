...
RUN curl -o  /tmp/pgbouncer-$PG_VERSION.tar.gz -L https://pgbouncer.github.io/downloads/files/$PG_VERSION/pgbouncer-$PG_VERSION.tar.gz && \
  cd /tmp && \
  # Unpack, compile
